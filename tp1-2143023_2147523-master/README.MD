...
| ------------------------------------------------- | :------: | :--------: |
| Respect des exigences fonctionnelles de l’énoncé  |   5.0    |     6      |
...
Il était demandé d'enlever les filters -0.5

Un test ne passe pas -0.5

La barre de sons de playlist.html ne devrait pas être statique. -0.5

Votre icone + n'est pas exactement comme celle demandée.

Vous faites une mauvaise utilisation de la balise <hr> -0.5

Vous avez des commentaires dans chaque page html -0.5
